...
public class JsonDataManager {
    ...
    public Object[][] getData(Class aClass, String mtd) throws Exception {
        String fullPageName = aClass.getName().toString();
        ...
        if (data.containsKey(pageName)) {
            ...
            throw new Exception(String.format("No test data for the Test : %s", pageName));
        }
    }
